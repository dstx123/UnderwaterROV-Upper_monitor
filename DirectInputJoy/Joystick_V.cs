    ...
    public class Joystick_V : IDisposable
    {
        ...
        private void OnTimerCallback(object state)
        {
            ...
            if (result == JoystickAPI.JOYERR_NOERROR)
            {
                ...
                GetXYZButtons(infoEx.dwXpos, infoEx.dwYpos, infoEx.dwZpos, infoEx.dwRpos,  ref buttons);
        ...
        private void GetXYZButtons(int x, int y, int z, int r, ref JoystickButtons buttons)
        {
            //处理X,Y轴
